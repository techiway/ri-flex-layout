...
@Directive()
export class StyleDirective extends BaseDirective implements DoCheck {

  protected override RI_DIRECTIVE_KEY = 'ngStyle';
...
export class RIDefaultStyleDirective extends StyleDirective implements DoCheck {
